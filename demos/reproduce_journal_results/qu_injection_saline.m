...
% script for the complete compensation of the saline injection sequence. Please
% load the dataset into data/
run('../../set_path.m');

input_file = 'data/injection_saline_6hz.HDF';
output_folder = 'injection_saline_fast_result';
...
%     'd1', 512, 'd2', 512, ...
%     'grid_size', [128, 128], ...
%     'max_dev', [26, 26, 1], 'max_shift', 10, 'use_parallel', true, ...
