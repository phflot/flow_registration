...
% script for the complete compensation of the saline injection 2 sequence. Please
% load the dataset into data/
run('../../set_path.m');

input_file = 'data/injection_saline_2_6hz.HDF';
output_folder = 'injection_saline_2_fast_result';
...
%     'd1', 512, 'd2', 512, ...
%     'grid_size', [128, 128], ...
%     'max_dev', [25, 25, 1], 'max_shift', 15, 'use_parallel', true, ...
